...
const Erc721Abi = [
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_sire', type: 'uint256' },
      { internalType: 'uint256', name: '_matron', type: 'uint256' },
    ],
    name: 'breed',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    name: 'yieldToken',
    outputs: [
      { internalType: 'contract YieldToken', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
    ...
    try {
      ...
      for (let i = 0; i < balance; i++) {
        const tokenId = await Erc721Contract.methods
          .tokenOfOwnerByIndex(body.accountAddress, i)
          .call();
